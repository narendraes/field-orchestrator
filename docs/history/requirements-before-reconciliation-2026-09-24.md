> Historical snapshot, superseded by the current requirements, architecture and root plan.md. Statements describe different past releases and may conflict; do not use as the current rebuild specification.
