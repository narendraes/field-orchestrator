  ...
  return <Stack space="space.200">
    ...
    {draft ? <Stack space="space.200">
      ...
      {draft.behaviorType === 'relationship' && <Stack space="space.150">
        ...
        <SectionMessage appearance="information" title="Numeric relationship pilot"><Text>Numeric rollups can be activated after validation. Target project size does not block activation. Structural events discover targets in pages and process each target separately; source updates trace affected targets. Pending updates to the same target are combined, and changed rollup fields are sent in one Jira edit. The test table displays up to ten matches. Five active relationship policies and no derived-field chaining remain pilot limits.</Text></SectionMessage>
